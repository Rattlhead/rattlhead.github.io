...
Вывод данных
=====
Для вывода данных используется команда print(""). Любой текст предназначенный для "Человека" пишется в " или ', программа его не обрабатывает и вывод в том же виде.
