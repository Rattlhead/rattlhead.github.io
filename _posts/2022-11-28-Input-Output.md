...
Данные вводятся внизу в консоли, сначал пишем данные потом нажимаем Enter.

<pre><code data-language="python">
# Узнать у пользователя его имя и поприветствовать его
print ("Как тебя зовут?") # Выводим текст
...
Это тоже переменная, но с одной особенностью данные в нее записываются один раз и больше изменить нельзя. Но в питоне нет возможности объявить неизменяемую переменную.
